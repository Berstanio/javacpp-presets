...
public static final int LTO_API_VERSION = 27;
...
public static native LLVMErrorRef LLVMOrcLLJITLookup(LLVMOrcLLJITRef J,
                                @Cast("LLVMOrcJITTargetAddress*") LongPointer Result,
                                @Cast("const char*") BytePointer Name);
public static native LLVMErrorRef LLVMOrcLLJITLookup(LLVMOrcLLJITRef J,
                                @Cast("LLVMOrcJITTargetAddress*") LongBuffer Result,
                                String Name);
public static native LLVMErrorRef LLVMOrcLLJITLookup(LLVMOrcLLJITRef J,
                                @Cast("LLVMOrcJITTargetAddress*") long[] Result,
                                @Cast("const char*") BytePointer Name);
public static native LLVMErrorRef LLVMOrcLLJITLookup(LLVMOrcLLJITRef J,
                                @Cast("LLVMOrcJITTargetAddress*") LongPointer Result,
                                String Name);
