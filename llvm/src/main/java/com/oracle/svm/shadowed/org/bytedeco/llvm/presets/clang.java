...
@Properties(inherit = LLVM.class, target = "com.oracle.svm.shadowed.org.bytedeco.llvm.clang", global = "com.oracle.svm.shadowed.org.bytedeco.llvm.global.clang", value = {@Platform(
