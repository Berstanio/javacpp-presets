...
package com.oracle.svm.shadowed.org.bytedeco.llvm.presets;
...
@Properties(inherit = javacpp.class, target = "com.oracle.svm.shadowed.org.bytedeco.llvm.LLVM", global = "com.oracle.svm.shadowed.org.bytedeco.llvm.global.LLVM", value = {@Platform(
...
public class LLVM implements InfoMapper {
    ...
    /** Returns {@code Loader.cacheResource("/com/oracle/svm/shadowed/org/bytedeco/llvm/" + Loader.getPlatform())}. */
    public static File cachePackage() throws IOException {
        return Loader.cacheResource("/com/oracle/svm/shadowed/org/bytedeco/llvm/" + Loader.getPlatform());
    }
